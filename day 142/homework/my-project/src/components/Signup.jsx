    ...
    <div className='flex justify-center pt-20'>
      <div className="h-180 w-100 bg-orange-100 border text-center">
        <form className="pt-10">
          ...
          <label className="text-3xl font-sans" htmlFor="repeat">Repeat Password</label><br /><br />
          <input className="border h-13 pl-5 text-2xl" id="repeat" type="password" placeholder="Repeat Password" /><br /><br />
